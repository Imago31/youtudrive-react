    ...
    <div className="main">
      <div className="menuSection">
        ...
        <div className="videoSection">
          {
          videoData.map((item) =>(
           item.type == type && <iframe className="yutu"  src={item.video} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
          ))
          }
